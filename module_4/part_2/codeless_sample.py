...
class TestRegistration():
    ...
    def test_registration(self):
        ...
        self.driver.find_element(By.ID, "id_registration-email").send_keys("1234567891012@mail.ru")
        self.driver.find_element(By.ID, "id_registration-password1").send_keys("123456789!")
        self.driver.find_element(By.ID, "id_registration-password2").send_keys("123456789!")
